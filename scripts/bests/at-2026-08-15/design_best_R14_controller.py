...
Best real-robot configuration discussed in this project:
    ...
    - six-stage delay approximation = 0.100 s total
...
# IMPORTANT:
# The experimentally measured pure delay has been discussed as ~0.11 s,
# but the CURRENT successful Arduino model uses coefficients corresponding
# to a 0.10 s / 6-stage cascade.  Keep 0.10 here to reproduce that design.
DELAY_SEC = 0.100
DELAY_STAGES = 6
